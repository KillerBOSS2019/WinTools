...
## Actions
- [Action] [VolumeMixer] Mute/Unmute process volume
    Format `[Muted/Unmute] Program [Program list]`
    Parameter
        [Muted/Unmute] This ether mutes or Unmute the program
        [Program list] This will list all possible program that have sound.
